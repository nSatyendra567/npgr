...
<main class="w-full bg-orange">
    ...
    ?>
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <img src="blogg/uploaded_img/<?= $fetch_posts['image']; ?>" alt="Post Image" class="w-full h-48 object-cover">
                <?php } ?>
    ...
    <a href="posts.php" class="py-2 px-3 h-fit rounded bg-yellow hover:bg-blue text-white text-lg text-center transition-all duration-200">View All Posts</a>
    </div>
