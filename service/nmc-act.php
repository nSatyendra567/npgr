...
<main class="sm:w-full mx-auto w-11/12 min-h-screen flex gap-10 max-w-7xl mx-auto py-10 md:py-16 flex-col md:flex-row">
    ...
    <div class="w-8/10 flex flex-col gap-5">
        <h2 class="text-2xl text-3xl">National Medical Commission Act
        </h2>
        <p class="">The National Medical Commission Act, 2019, marks a significant overhaul of medical education and regulatory practices in India. It replaces the previous Medical Council of India (MCI) with the National Medical Commission (NMC), aiming to streamline medical education, improve healthcare standards, and enhance transparency and accountability in the medical profession.</p>
        ...
        <h3 class="mt-3 text-2xl">Impact and Challenges</h3>
        <p class="">The NMC Act is expected to bring about positive changes in medical education and healthcare delivery by ensuring quality standards, promoting research and innovation, and addressing workforce challenges. However, challenges such as implementation issues, resistance from stakeholders, and ensuring equitable access to healthcare services remain critical areas of concern.</p>
        <h3 class="text-2xl">Conclusion</h3>
        <p class="">In conclusion, the National Medical Commission Act, 2019, represents a landmark reform in India's healthcare sector, aimed at improving medical education, enhancing regulatory practices, and ultimately, ensuring better healthcare outcomes for the population. By establishing the NMC and introducing transformative measures, the Act seeks to address long standing issues and pave the way for a more robust and efficient healthcare system in India.</p>
