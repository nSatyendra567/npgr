...
<main class="sm:w-full mx-auto w-11/12 min-h-screen flex gap-10 max-w-7xl mx-auto py-10 md:py-16 flex-col md:flex-row">
    ...
    <div class="w-8/10 flex flex-col gap-5">
        <h2 class="text-2xl text-3xl">Child Act
        </h2>
        <p class="">The Child Act is a crucial legislative framework designed to protect the rights and welfare of children, ensuring their holistic development and safeguarding them from exploitation, abuse, and neglect. This comprehensive legal framework encompasses various aspects of children’s rights and lays down provisions for their care, protection, education, and well-being.</p>

        <h3 class="text-2xl mb-3"> Key Sections and Provisions
        </h3>
        ...
        <h3 class="text-2xl mb-3 mt-3">Recent Amendments and New Laws
        </h3>
        <div class="w-full h-fit flex flex-col gap-5">
            <div class="flex items-center relative shadow w-full h-full rounded-md">
                <div class="w-1/6 flex justify-center items-center relative bg-yellow text-white h-full rounded-tl-md rounded-bl-md">
        ...
        <h3 class="text-2xl mt-3 mb-3">Implementation and Enforcement
        </h3>
        <div class="w-full h-fit flex flex-col gap-5">
            <div class="flex items-center relative shadow w-full h-full rounded-md">
                <div class="w-1/6 flex justify-center items-center relative bg-yellow text-white h-full rounded-tl-md rounded-bl-md">
        ...
        <p class="">In conclusion, the Child Act, supported by recent amendments and supplementary laws, plays a pivotal role in safeguarding the rights and well-being of children in India. By addressing various dimensions of child protection, education, health, and legal rights, the Act ensures a conducive environment for children to thrive and reach their full potential.
        </p>
    </div>
</main>
