...
<main class="sm:w-full mx-auto w-11/12 min-h-screen flex gap-10 max-w-7xl mx-auto py-10 md:py-16 flex-col md:flex-row">
    ...
    <div class="w-8/10 flex flex-col gap-5">
        <h2 class="text-2xl text-3xl">Indian Nursing Act
        </h2>
        <h3 class="text-2xl">The Indian Nursing Council Act, 1947
        </h3>
        ...
        <h3 class="text-2xl">The Nursing Council of India Act, 1951
        </h3>
        ...
        <h3 class="text-2xl">The Nurses and Midwives Act, 1956
        </h3>
