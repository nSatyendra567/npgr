...
<body>
    <nav class="w-full min-h-12 bg-white items-center">
        <div class="px-5 sm:px-10 lg:px-16 flex justify-between items-center">
            ...
            <div class="">
                <a href="<?php echo ROOT_URL ?>index.php">
                    <p class="text-2xl text-center animate-color-change">राष्ट्रीय लोक शिकायत एवं निवारण आयोग</p>
                </a>
                <a class="" href="<?php echo ROOT_URL ?>index.php">
                    <h1 class="text-xl text-center animate-color-change">The National Public Grievances & Redressal Commission</h1>
                </a>
                <p class="text-base">Legal Statutory Body Under the Legislation Government of NCT Delhi-India</p>
            </div>
        ...
        <!-- Socials -->
        <div class="fixed bg-transparent h-fit top-[50%] translate-y-[-70%] right-0">
