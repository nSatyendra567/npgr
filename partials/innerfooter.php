<footer class="relative w-full min-h-[100px]  bg-blue py-10 px-10 md:px-16 lg:px-24 xl:px-32">
    ...
    <ul class="foote_bottom_ul_amrc flex flex-wrap text-white font-bold justify-center space-x-4 mt-2 mb-10">
        <li><a href="../index.php" class="hover:underline hover:text-yellow font-bold">Home</a></li>
        <li><a href="../about.php" class="hover:underline hover:text-yellow font-bold">About</a></li>
        <li><a href="../service/legal-aid" class="hover:underline hover:text-yellow font-bold">Services</a></li>
        <li><a href="../case-status.php" class="hover:underline hover:text-yellow font-bold">Case Status</a></li>
        <li><a href="../governing-bodies.php" class="hover:underline hover:text-yellow font-bold">Governing Bodies</a></li>
