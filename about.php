...
<main class="sm:w-full mx-auto w-11/12 min-h-screen flex justify-center">
    <div class="max-w-7xl w-full flex flex-col md:flex-row gap-10  pt-10 pb-10 md:pb-16">
        ...
        <div class="w-8/10 flex flex-col gap-3">
            <h2 class="text-2xl md:text-3xl">About NPGRC</h2>
            <p class="">Founded on September 9, 2017, the National Public Grievance and Redressal Commission (NPGRC) was established following recommendations made in 2017, aimed at creating a robust legal framework for addressing public grievances in India. Operating independently under the Indian constitution act , the commission holds jurisdiction over grievances spanning both public and private sectors. Led by Honorable Judge Mr. Birendra Singh as Member/Secretary, the NPGRC ensures thorough and impartial resolution of issues, upholding legal standards and promoting justice.</p>

            <p class="">The NPGRC operates within a comprehensive legal framework that includes key legislative acts crucial to its mandate. The Human Rights Act empowers the commission to investigate complaints related to violations of fundamental rights. Under the Child Welfare Act, the NPGRC intervenes in matters concerning the welfare and rights of children, ensuring their protection and well-being. The Women's Rights Act enables the commission to address grievances related to gender-based discrimination, harassment, and violence. Additionally, the Environmental Protection Act grants authority to investigate complaints regarding environmental degradation, pollution, and non-compliance with environmental regulations. These acts provide the NPGRC with the legal tools necessary to address a wide array of issues affecting public and private sectors.</p>

            <p class="">Organized under the leadership of Honorable Judge Mr. Birendra Singh, the NPGRC employs a structured approach to grievance redressal. Its organizational structure includes dedicated committees and expert panels tasked with handling grievance investigations, mediation, and adjudication processes. This hierarchical setup ensures systematic handling of complaints, ensuring fairness, and adherence to legal principles throughout the resolution process.</p>
            <p class="">Operational procedures at the NPGRC are designed to facilitate efficient grievance handling from initial complaint registration to final resolution. The commission employs rigorous investigation methods, evidence gathering, and mediation techniques to substantiate claims and achieve amicable settlements where possible. Case studies illustrate successful outcomes and challenges faced, showcasing the commission's role in resolving complex disputes and promoting accountability across sectors.</p>
            <p class="">Collaboration with the Legal Services Authority, established under the Legal Services Authorities Act of 1987, enhances the NPGRC's reach and effectiveness in providing legal aid and representation. Sections 12 and 13 of the Act govern this collaboration, emphasizing equitable access to justice for all citizens, particularly marginalized communities. This partnership underscores the commission's commitment to promoting legal literacy and ensuring fair representation in grievance resolution processes.</p>
            <p class="">The impact of the NPGRC extends beyond individual grievance redressal to influencing systemic reforms and policy changes. Through landmark decisions and proactive interventions, the commission contributes to shaping legal precedents and fostering a culture of transparency and accountability in governance. Its role in safeguarding constitutional rights and promoting social justice underscores its significance in India's legal landscape.</p>
            ...
            <h3 class="text-xl md:text-2xl">Challenges and Reform Initiatives</h3>
