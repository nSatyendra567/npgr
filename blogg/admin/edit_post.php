...
<section class="post-editor">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <!-- <textarea name="content" required cols="30" rows="10"></textarea> -->
...
<!-- <script>
    document.addEventListener("DOMContentLoaded", function() {
        tinymce.init({
            ...
            toolbar: 'undo redo | formatselect | bold italic underline strikethrough | bullist numlist | link | removeformat',
            menubar: false,
            setup: function (editor) {
                // Show the hidden textarea after TinyMCE initialization
